...
import (
	"Go-ddd-base-init/domain/entity"
	"fmt"
...
func CIBuild() (*gorm.DB, error) {
	var err error
	DBURL := fmt.Sprintf("host=%s port=%s user=%s dbname=%s sslmode=disable password=%s", "127.0.0.1", "5432", "steven", "Go-ddd-base-init-test", "password")
