...
import (
	"Go-ddd-base-init/infrastructure/auth"
	"Go-ddd-base-init/infrastructure/persistence"
	"Go-ddd-base-init/interfaces"
	"Go-ddd-base-init/interfaces/fileupload"
	"Go-ddd-base-init/interfaces/middleware"
